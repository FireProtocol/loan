 ...
 * @author Fire
 */
contract HT is FToken {

    /**
     * @notice init HT contract
    ...
    function () external payable {
        ...
        require(err == uint(Error.SUCCESS), "HT::mint failure");
    }
    ...
    function repayBorrow() external payable {
        ...
        require(err == uint(Error.SUCCESS), "HT::repayBorrow failure");
    }
    ...
    function liquidateBorrow(address _borrower, FToken _fTokenCollateral) external payable {
        ...
        require(err == uint(Error.SUCCESS), "HT::liquidateBorrow failure");
    }
    ...
    function doTransferIn(address _from, uint _amount) internal returns (uint) {
        require(msg.sender == _from, "HT::doTransferIn sender failure");
        require(msg.value == _amount, "HT::doTransferIn value failure");
        return _amount;
    }
